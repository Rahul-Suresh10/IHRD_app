...
import 'package:flutter_application_1/college_list/AppliedScience/university_list4.dart';
...
class ASUniversityList4 extends StatefulWidget {
  const ASUniversityList4({super.key});

  @override
  State<ASUniversityList4> createState() => _ASUniversityList4State();
}

class _ASUniversityList4State extends State<ASUniversityList4> {
  //Scroll Controller
                ...
                const Padding(
                 ...
                 SizedBox(
                    ...
                    child: GridView.builder(
                        itemCount: applied_science_university4_list.length,
                        shrinkWrap: true,
                        gridDelegate:
                        ...
                        itemBuilder: (context, index) {
                          return PolyClgTile(
                              ...
                              name: applied_science_university4_list[index].name,
                            
                              page: applied_science_university4_list[index].page);
                        })),
              ],
            )),
      ),

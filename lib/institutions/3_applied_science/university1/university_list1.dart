...
//importing the applied_science_university1_list
import 'package:flutter_application_1/college_list/AppliedScience/university_list1.dart';
...
class ASUniversityList1 extends StatefulWidget {
  const ASUniversityList1({super.key});

  @override
  State<ASUniversityList1> createState() => _ASUniversityList1State();
}

class _ASUniversityList1State extends State<ASUniversityList1> {
  //Scroll Controller
              ...
              children: <Widget>[
                ...
                SizedBox(
                    ...
                    child: GridView.builder(
                        itemCount: applied_science_university1_list.length,
                        shrinkWrap: true,
                        gridDelegate:
                        ...
                        itemBuilder: (context, index) {
                          return PolyClgTile(
                              ...
                              name: applied_science_university1_list[index].name,
                             
                              page: applied_science_university1_list[index].page);
                        })),
              ],
            )),
      ),
